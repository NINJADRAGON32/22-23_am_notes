#lists are a class in jave
# array is the equivalant -> string[] grocerylist = new string [10];

#Python Lists are mutable -> changeable 

listy = ["hello",2,["t","h","e"], "World"]
print(listy)

#strings and lists are very similar
# behavior and characteristics are similar
#sequence data types - multiple items put together in one spot

backpack = ["computer","pencils","tek dek","water","samwich","books"]
print(backpack[0]) #prints computer->indexed
print(backpack[2])
#to change an item
backpack[4]="popeyes chimken samwich"
print (backpack)
...
numbers= range (0,99)
print (numbers)
alphabet = range(97,(97+26))
print (alphabet)
morse=[".-","-...","-.-.","-..",".","..-.","--.","....","..",".---","-.-",".-..","--","-.","---",".--.","--.-",".-.","...","-","..-","...-",".--","-..-","-.--","--.."]
alphaList=["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"]

print(morse[alphaList.index("h")],morse[alphaList.index("o")],morse[alphaList.index("w")],morse[alphaList.index("a")],morse[alphaList.index("r")],morse[alphaList.index("d")])
...
print(f"sum: {sum(randoNumbas)}")
print(f"min: {min(randoNumbas)}")
print(f"max: {max(randoNumbas)}")
print(f"sum: {sum(randoNumbas)/len(randoNumbas)}")
...
'''
    ...
    min-> minimum
    max-> maximum
    len-> length-> how many items in list
